...
import { zonedDayKey } from "@/lib/date-utils";
...
export function LancamentosContent() {
  ...
  // Dia de Brasilia, nao o dia UTC: `toISOString()` fazia o formulario abrir
  // preenchido com a data de AMANHA entre 21:00 e 23:59.
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    setLoading(true);
    // Offset explicito: sem ele o meio-dia e interpretado no fuso do NAVEGADOR,
    // entao o instante gravado variava conforme a maquina de quem lancou.
    const occurredAt = new Date(`${date}T12:00:00-03:00`).toISOString();
